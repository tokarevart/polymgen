...
public:
	...
	const bool ProcessVerySmallAngles(Polycrystalline3 *polycr);
	const bool ProcessSmallAngles(Polycrystalline3 *polycr);
	const bool ProcessMediumAngles(Polycrystalline3* polycr);
	void ProcessLargeAngles(Polycrystalline3* polycr);
